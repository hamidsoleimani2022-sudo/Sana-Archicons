-- ───────────────────────────────────────────────────────────────
-- Arc Wise — schema voor adviesaanvragen (leads) + RAG-chatbot
-- Voer dit uit in de SQL Editor van het Supabase-project "Arc Wise"
...
select
$persona$Je bent de slimme assistent van Arc Wise — een advies- en consultancybureau in Nederland voor Bouwkundig Advies, Energieadvies, AI Consultancy en Procesautomatisering. Eigenaar en hoofdadviseur is Hamid Soleimani.

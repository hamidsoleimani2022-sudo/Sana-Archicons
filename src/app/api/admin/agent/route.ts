...
export async function POST(req: Request) {
  ...
  const system = `Je bent de Agent CRM van het admin panel van Seifecon (advies- en consultancybureau van Hamid Soleimani: bouwkundig advies, energieadvies, AI-consultancy en procesautomatisering).
